...
def validate_final_parity_polish(errors: list[str]) -> None:
    ...
    if '<div class="sidebar-version"><span>WWZ Command Centre</span><strong>v1.54.4</strong></div>' not in dashboard:
        errors.append("dashboard.html: command-centre footer release label is stale.")

    if "Website v1.54.4 · Bot v1.55.3" not in index:
    ...
    lazy_script = 'assets/js/dashboard/lazy-assets.js?v=1.54.4&amp;rev=chernarus-public-markers-1'
    ...
    lazy_view_assets = (
        ("dashboard map", f"assets/js/pages/dashboard-map-loader.js?v=1.22.94&rev=chernarus-public-markers-1", "ensureDashboardMap"),
...
def validate_pwa(errors: list[str], info: list[str]) -> None:
    ...
    launch_requirements = {
        "index.html": ("Live now · 26 slots", "91 random PvP loadouts", "Bot v1.55.3"),
        "dashboard.html": ("LIVE · 26 SLOTS", "assets/js/dashboard/server-context.js?v=1.42.0&amp;rev=livonia-live-1", "assets/js/dashboard/lazy-assets.js?v=1.54.4&amp;rev=chernarus-public-markers-1"),
    ...
    required_sw_tokens = (
        "const WWZ_PWA_VERSION = '1.54.4'",
        "const WWZ_PWA_UPDATE_REVISION = '2026-09-19-website-v1-54-4-chernarus-public-markers'",
    ...
    expected_pwa_js = 'assets/js/pwa.js?v=1.54.4&rev=chernarus-public-markers-1'
