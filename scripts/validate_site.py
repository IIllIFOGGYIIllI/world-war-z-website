...
def validate_final_parity_polish(errors: list[str]) -> None:
    ...
    if "Website v1.25.4 · Bot v1.19.4" not in index:
    ...
    lazy_script = 'assets/js/dashboard/lazy-assets.js?v=1.25.4'
...
def validate_pwa(errors: list[str], info: list[str]) -> None:
    ...
    required_sw_tokens = (
        "const WWZ_PWA_VERSION = '1.25.4'",
        "const WWZ_PWA_CACHE_REVISION = 'chernarus-pve-1'",
