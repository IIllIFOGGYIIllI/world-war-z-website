...
const APP_SHELL = [
  ...
  './assets/css/pwa.css?v=1.22.87',
  './assets/css/dashboard/core.css?v=1.22.87',
  './assets/css/dashboard/gateway.css?v=1.22.87&rev=3',
  './assets/css/dashboard/workspace.css?v=1.22.87',
  './assets/css/dashboard/overview-map-preview.css?v=1.22.87',
  './assets/css/site-polish.css?v=1.22.87',
  './assets/js/pwa.js?v=1.22.87',
  './assets/js/core/http.js?v=1.22.87&rev=2',
  './assets/js/dashboard/lazy-assets.js?v=1.22.87',
  './assets/js/dashboard/shell.js?v=1.22.87',
  './assets/js/dashboard/core.js?v=1.22.87&rev=restore-1',
  './assets/js/dashboard/formatters.js?v=1.22.87',
  './assets/js/dashboard/server-context.js?v=1.22.87&rev=6',
  './assets/js/dashboard/admin-access.js?v=1.22.87',
  './assets/js/dashboard/account.js?v=1.22.87',
  './assets/js/dashboard/bootstrap.js?v=1.22.87&rev=restore-1'
].map(scopedUrl);
