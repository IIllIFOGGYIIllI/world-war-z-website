...
const WWZ_PWA_UPDATE_REVISION = '2026-09-04-website-v1-29-1';
...
const UPDATE_INVALIDATIONS = [
  ...
  './flags.html',
  // Clear the original v1.29.0 Flag Claims request keys before serving the polished v1.29.1 UI.
  ...
  './assets/js/pages/flags.js?v=1.29.1&rev=flag-claims-2',
  './assets/css/pages/flags.css?v=1.29.1&rev=flag-claims-2',
  './assets/js/dashboard/flag-claims.js?v=1.29.1&rev=flag-claims-2',
  './assets/css/dashboard/flag-claims.css?v=1.29.1&rev=flag-claims-2',
  './assets/js/dashboard/lazy-assets.js?v=1.29.1&rev=flag-claims-2',
  './assets/js/pages/home.js?v=1.22.93',
  './assets/js/pwa.js?v=1.22.93',
  './assets/css/pwa.css?v=1.22.93',
  './assets/data/companion-release.json'
