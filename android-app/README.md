# World War Z Companion — Android v1.0.1
...
Android v1.0.1 uses `appVersionCode` 10001. Future native releases should increment both fields in `twa-manifest.json`, for example:
