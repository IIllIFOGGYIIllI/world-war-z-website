(() => {
  ...
  {"name": "flag", "category": "Flag Claims", "description": "Server-scoped World War Z flag claim group.", "access": "Member"},
  {"name": "flag list", "category": "Flag Claims", "description": "Browse the shared flag catalogue and this server's current availability.", "access": "Member"},
  {"name": "flag info", "category": "Flag Claims", "description": "View one flag, its capacity, special status and current owners.", "access": "Member"},
  {"name": "flag request", "category": "Flag Claims", "description": "Request an available flag for yourself or your group for Admin approval.", "access": "Member"},
  {"name": "flag mine", "category": "Flag Claims", "description": "View your active and pending flag claims on the selected server.", "access": "Member"},
  {"name": "flag release", "category": "Flag Claims", "description": "Voluntarily release your own active flag claim.", "access": "Member"},
  {"name": "flag cancel", "category": "Flag Claims", "description": "Cancel one of your pending flag requests.", "access": "Member"},
  {"name": "flag admin pending", "category": "Flag Claims", "description": "Review pending flag requests for this server.", "access": "Admin"},
  {"name": "flag admin approve", "category": "Flag Claims", "description": "Approve a pending flag request.", "access": "Admin"},
  {"name": "flag admin reject", "category": "Flag Claims", "description": "Reject a pending flag request with an optional reason.", "access": "Admin"},
  {"name": "flag admin assign", "category": "Flag Claims", "description": "Manually assign a flag to a player or group.", "access": "Admin"},
  {"name": "flag admin revoke", "category": "Flag Claims", "description": "Revoke an active flag claim.", "access": "Admin"},
  {"name": "flag admin transfer", "category": "Flag Claims", "description": "Transfer an active flag to a new player or group.", "access": "Admin"},
  {"name": "flag admin channels", "category": "Flag Claims", "description": "Configure the review and public Discord flag channels.", "access": "Admin"},
  {"name": "flag admin publish", "category": "Flag Claims", "description": "Publish or refresh the server's live Discord flag panel.", "access": "Admin"},
