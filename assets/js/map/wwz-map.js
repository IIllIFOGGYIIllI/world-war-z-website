(() => {
  ...
  const MAP_CONFIGS = Object.freeze({
    chernarus: Object.freeze({
      ...
      mapMetres: 15360,
      mapUnits: 240,
      satelliteUrl: 'assets/maps/chernarus/tiles/z{z}/{y}/{x}.webp?v=1.22.71',
      roadUrl: 'assets/maps/chernarus/roads.geojson?v=1.22.71',
      labelUrl: 'assets/maps/chernarus/labels.json?v=1.22.71',
    ...
    livonia: Object.freeze({
      ...
      mapMetres: 12800,
      mapUnits: 240,
      satelliteUrl: 'assets/maps/livonia/tiles/{z}/{x}/{y}.webp?v=1.22.71',
      roadUrl: 'assets/maps/livonia/roads.geojson?v=1.22.71',
      labelUrl: 'assets/maps/livonia/labels.json?v=1.22.71',
