(() => {
  ...
  const updateDashboardLabels = (server) => {
    ...
    if (mapPreview) {
      mapPreview.src = server.map_key === 'livonia'
        ? 'assets/maps/livonia/tiles/0/0/0.webp?v=1.22.76'
        : 'assets/maps/chernarus/tiles/z0/0/0.webp?v=1.22.76';
  ...
  const renderServerCard = (server) => {
    ...
    iconImage.src = server.icon_url || 'assets/world-war-z-logo.webp?v=1.22.76';
    iconImage.alt = '';
