...
const ADMIN_IDENTITY_URL = `${DASHBOARD_API_BASE}/api/admin/account/identity`;
const ADMIN_IDENTITY_ACTION_URL = `${DASHBOARD_API_BASE}/api/admin/account/identity/action`;
...
const ADMIN_ZONES_URL = `${DASHBOARD_API_BASE}/api/admin/zones`;
const ADMIN_ZONES_ACTION_URL = `${DASHBOARD_API_BASE}/api/admin/zones/action`;
const ADMIN_ONLINE_PLAYERS_MAP_URL = `${DASHBOARD_API_BASE}/api/admin/map/online-players`;
const ADMIN_SERVER_FEEDS_URL = `${DASHBOARD_API_BASE}/api/admin/server-feeds`;
const ADMIN_SERVER_FEEDS_ACTION_URL = `${DASHBOARD_API_BASE}/api/admin/server-feeds/action`;
const ADMIN_MODERATION_CENTRE_URL = `${DASHBOARD_API_BASE}/api/admin/moderation/centre`;
...
const OWNER_DISCORD_ONBOARDING_CONFIG_URL = `${DASHBOARD_API_BASE}/api/owner/discord-onboarding/config`;
const OWNER_COMMUNITY_TOOLS_CONFIG_URL = `${DASHBOARD_API_BASE}/api/owner/community-tools/config`;
const OWNER_COMMUNITY_TOOLS_ACTION_URL = `${DASHBOARD_API_BASE}/api/owner/community-tools/action`;
...
const PLAYER_ACTIONS = {
  ...
  add_watch: { mark: '◉', title: 'Add this player to the staff watchlist?', description: 'The selected PlayStation ID will be added to this server’s private watchlist.', warning: 'Watchlist entries are server-scoped and visible only to authorized staff.', reasonLabel: 'Watchlist reason', reasonHelp: 'Required · 3–1,000 characters', submitLabel: 'Add to watchlist' },
  remove_watch: { mark: '○', title: 'Remove this player from the staff watchlist?', description: 'The selected PlayStation ID will no longer be flagged for staff attention on this server.', warning: 'The protected player-action audit still records who removed the watch and why.', reasonLabel: 'Removal reason', reasonHelp: 'Required · 3–1,000 characters', submitLabel: 'Remove from watchlist' },
  ...
  discord_timeout: { mark: '◷', title: 'Timeout this Discord member?', description: 'Choose a Discord timeout duration from one minute up to Discord’s 28-day maximum.', warning: 'A numbered active moderation case is created and Railway reconciles the case automatically when the timeout expires.', reasonLabel: 'Timeout reason', reasonHelp: 'Required · 3–1,000 characters', submitLabel: 'Apply Discord timeout', timeoutSchedule: true },
  discord_untimeout: { mark: '↺', title: 'Remove this Discord timeout?', description: 'The linked member’s active Discord timeout will be cleared immediately.', warning: 'The original timeout case is closed and a linked untimeout case is permanently recorded.', reasonLabel: 'Untimeout reason', reasonHelp: 'Required · 3–1,000 characters', submitLabel: 'Remove Discord timeout' },
...
const onboardingRefreshButton = document.querySelector('[data-refresh-onboarding]');
const onboardingSaveButton = document.querySelector('[data-save-onboarding]');
const onboardingMessage = document.querySelector('[data-onboarding-message]');
const onboardingJoinRolesEnabled = document.querySelector('[data-onboarding-join-roles-enabled]');
const onboardingJoinRoles = document.querySelector('[data-onboarding-join-roles]');
const onboardingWelcomeEnabled = document.querySelector('[data-onboarding-welcome-enabled]');
const onboardingWelcomeChannel = document.querySelector('[data-onboarding-welcome-channel]');
const onboardingWelcomeEmbed = document.querySelector('[data-onboarding-welcome-embed]');
const onboardingWelcomeTitle = document.querySelector('[data-onboarding-welcome-title]');
const onboardingWelcomeMessage = document.querySelector('[data-onboarding-welcome-message]');
const onboardingWelcomeColour = document.querySelector('[data-onboarding-welcome-colour]');
const onboardingWelcomeDmEnabled = document.querySelector('[data-onboarding-welcome-dm-enabled]');
const onboardingWelcomeDmMessage = document.querySelector('[data-onboarding-welcome-dm-message]');
const onboardingLeaveEnabled = document.querySelector('[data-onboarding-leave-enabled]');
const onboardingLeaveChannel = document.querySelector('[data-onboarding-leave-channel]');
const onboardingLeaveEmbed = document.querySelector('[data-onboarding-leave-embed]');
const onboardingLeaveTitle = document.querySelector('[data-onboarding-leave-title]');
const onboardingLeaveMessage = document.querySelector('[data-onboarding-leave-message]');
const onboardingLeaveColour = document.querySelector('[data-onboarding-leave-colour]');
const onboardingPlaceholderList = document.querySelector('[data-onboarding-placeholders]');
const onboardingUpdated = document.querySelector('[data-onboarding-updated]');
const communityRefreshButton = document.querySelector('[data-refresh-community-tools]');
const communityMessage = document.querySelector('[data-community-message]');
const communityError = document.querySelector('[data-community-error]');
const communityEmbedWebhook = document.querySelector('[data-community-embed-webhook]');
const communityEmbedSender = document.querySelector('[data-community-embed-sender]');
const communityEmbedAvatar = document.querySelector('[data-community-embed-avatar]');
const communityEmbedContent = document.querySelector('[data-community-embed-content]');
const communityEmbedTitle = document.querySelector('[data-community-embed-title]');
const communityEmbedColour = document.querySelector('[data-community-embed-colour]');
const communityEmbedDescription = document.querySelector('[data-community-embed-description]');
const communityEmbedFooter = document.querySelector('[data-community-embed-footer]');
const communityEmbedLink = document.querySelector('[data-community-embed-link]');
const communityEmbedThumbnail = document.querySelector('[data-community-embed-thumbnail]');
const communityEmbedImage = document.querySelector('[data-community-embed-image]');
const communitySendEmbedButton = document.querySelector('[data-community-send-embed]');
const communityStickyId = document.querySelector('[data-community-sticky-id]');
const communityStickyChannel = document.querySelector('[data-community-sticky-channel]');
const communityStickyEnabled = document.querySelector('[data-community-sticky-enabled]');
const communityStickyEmbed = document.querySelector('[data-community-sticky-embed]');
const communityStickyTitle = document.querySelector('[data-community-sticky-title]');
const communityStickyColour = document.querySelector('[data-community-sticky-colour]');
const communityStickyContent = document.querySelector('[data-community-sticky-content]');
const communityStickyThreshold = document.querySelector('[data-community-sticky-threshold]');
const communityStickyInterval = document.querySelector('[data-community-sticky-interval]');
const communitySaveStickyButton = document.querySelector('[data-community-save-sticky]');
const communityClearStickyButton = document.querySelector('[data-community-clear-sticky]');
const communityStickyList = document.querySelector('[data-community-sticky-list]');
const communityStickyEmpty = document.querySelector('[data-community-sticky-empty]');
const communityRolePanelId = document.querySelector('[data-community-role-panel-id]');
const communityRolePanelChannel = document.querySelector('[data-community-role-panel-channel]');
const communityRolePanelEnabled = document.querySelector('[data-community-role-panel-enabled]');
const communityRolePanelTitle = document.querySelector('[data-community-role-panel-title]');
const communityRolePanelColour = document.querySelector('[data-community-role-panel-colour]');
const communityRolePanelDescription = document.querySelector('[data-community-role-panel-description]');
const communityRolePanelRoles = document.querySelector('[data-community-role-panel-roles]');
const communitySaveRolePanelButton = document.querySelector('[data-community-save-role-panel]');
const communityClearRolePanelButton = document.querySelector('[data-community-clear-role-panel]');
const communityRolePanelList = document.querySelector('[data-community-role-panel-list]');
const communityRolePanelEmpty = document.querySelector('[data-community-role-panel-empty]');
...
const playerActionTimeoutFields = document.querySelector('[data-player-action-timeout-fields]');
const playerActionTimeoutDuration = document.querySelector('[data-player-action-timeout-duration]');
...
let onboardingRequestInProgress = false;
let onboardingConfiguration = { settings: {}, roles: [], channels: [], placeholders: [] };
let communityToolsRequestInProgress = false;
let communityToolsConfiguration = { channels: [], roles: [], webhooks: [], stickies: [], role_panels: [] };
