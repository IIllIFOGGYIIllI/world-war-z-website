(() => {
  ...
  const loadMyWwzExperience = () => {
    if (!document.querySelector('link[data-wwz-my-wwz-style]')) {
      ...
      style.href = 'assets/css/dashboard/my-wwz.css?v=1.40.0&rev=member-home-overhaul-1';
    ...
    script.src = 'assets/js/dashboard/my-wwz.js?v=1.40.0&rev=member-home-overhaul-1';
    script.async = true;
